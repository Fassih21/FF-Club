      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 md:grid-cols-3">
        <div>
          <div className="flex items-center gap-3">
            <span className="flex h-9 w-9 items-center justify-center rounded-sm bg-primary text-primary-foreground font-display">
              FF
            </span>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            ...
            <li>
              <a className="hover:text-primary" href={BUSINESS.facebook} target="_blank" rel="noopener noreferrer">
                Facebook
              </a>
            </li>
